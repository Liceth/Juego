...
public class medio extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parse.initialize(this, "R9VUvqgLHHBl2HABFQ4QitKFkf0we66jBNfWFCjP", "SJSGFEVCMriNzEBQAxJ2PYFT0Tzu1lJBBTmOBm6e");
        ...
        b18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                medio.this.startActivity(new Intent(medio.this, historial.class));
